import { ChainId, Token, Pair, TokenAmount, WDEV as WETH, Price } from '../src'

describe('Pair', () => {
  const USDC = new Token(ChainId.ROPSTEN, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.ROPSTEN, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI', 'DAI Stablecoin')

  describe('constructor', () => {
    it('cannot be used for tokens on different chains', () => {
      expect(() => new Pair(new TokenAmount(USDC, '100'), new TokenAmount(WETH[ChainId.STANDALONE], '100'))).toThrow(
        'CHAIN_IDS'
      )
    })
  })
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0xe0089381d08F4C2dC02B824E51Bd60e00fc70596')
    })
  })
