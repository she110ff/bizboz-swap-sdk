...
import { ChainId, CurrencyAmount, DEV, Pair, Percent, Route, Router, Token, TokenAmount, Trade, WDEV as WETH } from '../src'
...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(new TokenAmount(WETH[ChainId.ROPSTEN], '1000'), new TokenAmount(token0, '1000'))
    ...
    describe('exact in', () => {
      it('ether to token1', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x51',
          [WETH[ChainId.ROPSTEN].address, token0.address, token1.address],
      ...
      it('token1 to ether', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          '0x51',
          [token1.address, token0.address, WETH[ChainId.ROPSTEN].address],
          '0x0000000000000000000000000000000000000004',
        ])
